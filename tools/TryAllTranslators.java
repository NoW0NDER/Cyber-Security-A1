...
public class TryAllTranslators {
	public static void main(String[] args) throws Exception {
		if (args.length < 2) {
			System.out.println("usage: java TryAllTranslators encryptedfile cpath");
			System.exit(0);
		}
		String encFile = args[0];
		String mapdir = args[1];
		String mapFile;
		...
		{
			char c = (char)((int)'A'+i);
			mapFile = mapdir+File.separator+c+c+".txt";

			System.out.println("Try mapping file "+mapFile+" (i="+i+").......");
